...
CREATE TABLE book_language (  --done
    language_id INT,
...
CREATE TABLE customer_address ( --?? why it is not many to many relationship?
    customer_id INT,
    address_id INT,
    status_id INT,
...
CREATE TABLE shipping_method (  --done
    method_id INT,
...
CREATE TABLE cust_order ( --done
    order_id INT IDENTITY,
    order_date DATETIME,  --created_at
    customer_id INT,
...
CREATE TABLE order_status (  --done
    status_id INT,
...
CREATE TABLE order_history (  --acc fact
